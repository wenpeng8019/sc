...
#   scc app.sc --target templates/targets/android.target
...
# 呈现最小构建链路（细节见 templates/targets/android-pkg.sh，与 hello-ios 手工拼 .app 对称）。
#
