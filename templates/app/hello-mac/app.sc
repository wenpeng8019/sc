# hello-mac —— sc 桌面 app 脚手架（macOS / Cocoa）
#
# 最小的原生窗口程序：打开窗口、跑主循环、响应输入、干净退出。
# 拷走本目录改名，即可作为你自己 macOS app 的起点。
#
...
fnc main: i4
    ...
    print "wsi ", major, ".", minor, ".", rev, " · 桌面 app 脚手架 (macOS)\n"

    # ---- 创建并显示窗口 ----
    var win: ::sc_window& = wsi_win_create(960, 540, "sc · hello-mac", nil, nil)
    if win == nil
        print "窗口创建失败\n"
        wsi_app_cleanup()
        return 1
