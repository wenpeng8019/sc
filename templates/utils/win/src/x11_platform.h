...
typedef struct _GLFWlibraryX11
{
    ...
    // Context for mapping window XIDs to _sc_window pointers
    XContext        context;
    // XIM input method
    XIM             im;
...
GLFWbool _glfwCreateWindowX11(_sc_window* window, const _GLFWwndconfig* wndconfig, const _GLFWctxconfig* ctxconfig, const _GLFWfbconfig* fbconfig);
...
void _glfwSetWindowSizeLimitsX11(_sc_window* window, int minwidth, int minheight, int maxwidth, int maxheight);
...
void _glfwGetWindowFrameSizeX11(_sc_window* window, int* left, int* top, int* right, int* bottom);
...
void _glfwSetWindowMonitorX11(_sc_window* window, _sc_monitor* monitor, int xpos, int ypos, int width, int height, int refreshRate);
...
void _glfwSetCursorPosX11(_sc_window* window, double xpos, double ypos);
...
GLFWbool _glfwCreateCursorX11(_sc_cursor* cursor, const GLFWimage* image, int xhot, int yhot);
...
VkResult _glfwCreateWindowSurfaceX11(VkInstance instance, _sc_window* window, const VkAllocationCallbacks* allocator, VkSurfaceKHR* surface);

void _glfwFreeMonitorX11(_sc_monitor* monitor);
void _glfwGetMonitorPosX11(_sc_monitor* monitor, int* xpos, int* ypos);
void _glfwGetMonitorContentScaleX11(_sc_monitor* monitor, float* xscale, float* yscale);
void _glfwGetMonitorWorkareaX11(_sc_monitor* monitor, int* xpos, int* ypos, int* width, int* height);
...
GLFWbool _glfwCreateContextGLX(_sc_window* window,
                               const _GLFWctxconfig* ctxconfig,
                               const _GLFWfbconfig* fbconfig);
void _glfwDestroyContextGLX(_sc_window* window);
