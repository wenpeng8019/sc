...
int null_init(void)
{
    ...
    g_wsi.null.keycodes[NULL_SC_KP_5]          = SC_KEY_KP_5;
    g_wsi.null.keycodes[NULL_SC_KP_6]          = SC_KEY_KP_6;
    g_wsi.null.keycodes[NULL_SC_KP_7]          = SC_KEY_KP_7;
    g_wsi.null.keycodes[NULL_SC_KP_8]          = SC_KEY_KP_8;
    g_wsi.null.keycodes[NULL_SC_KP_9]          = SC_KEY_KP_9;
    g_wsi.null.keycodes[NULL_SC_KP_DECIMAL]    = SC_KEY_KP_DECIMAL;
    g_wsi.null.keycodes[NULL_SC_KP_DIVIDE]     = SC_KEY_KP_DIVIDE;
    g_wsi.null.keycodes[NULL_SC_KP_MULTIPLY]   = SC_KEY_KP_MULTIPLY;
    g_wsi.null.keycodes[NULL_SC_KP_SUBTRACT]   = SC_KEY_KP_SUBTRACT;
    g_wsi.null.keycodes[NULL_SC_KP_ADD]        = SC_KEY_KP_ADD;
    g_wsi.null.keycodes[NULL_SC_KP_ENTER]      = SC_KEY_KP_ENTER;
    g_wsi.null.keycodes[NULL_SC_KP_EQUAL]      = SC_KEY_KP_EQUAL;
    g_wsi.null.keycodes[NULL_SC_LEFT_SHIFT]    = SC_KEY_LEFT_SHIFT;
    g_wsi.null.keycodes[NULL_SC_LEFT_CONTROL]  = SC_KEY_LEFT_CONTROL;
    g_wsi.null.keycodes[NULL_SC_LEFT_ALT]      = SC_KEY_LEFT_ALT;
    g_wsi.null.keycodes[NULL_SC_LEFT_SUPER]    = SC_KEY_LEFT_SUPER;
    g_wsi.null.keycodes[NULL_SC_RIGHT_SHIFT]   = SC_KEY_RIGHT_SHIFT;
    g_wsi.null.keycodes[NULL_SC_RIGHT_CONTROL] = SC_KEY_RIGHT_CONTROL;
    g_wsi.null.keycodes[NULL_SC_RIGHT_ALT]     = SC_KEY_RIGHT_ALT;
    g_wsi.null.keycodes[NULL_SC_RIGHT_SUPER]   = SC_KEY_RIGHT_SUPER;
    g_wsi.null.keycodes[NULL_SC_MENU]          = SC_KEY_MENU;

    for (scancode = NULL_SC_FIRST;  scancode < NULL_SC_LAST;  scancode++)
    {
