...
static sc_afat __sctok_cd_gauge_combine(__sctok_in *_this) {
    ...
    if (i > b) {
        /* line 24 */
        return ((sc_afat){(void *)(intptr_t)(i), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0});
    }
    /* line 25 */
    return ((sc_afat){(void *)(intptr_t)(b), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0});
}
...
static uint8_t __scdep_0_follow(__scdep_in *_this) {
    ...
    if (_this->active >= 0) {
        ...
        /* line 35 */
        token_set(hits, ((sc_afat){(void *)(intptr_t)(h + 1), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    }
    /* line 36 */
    return false;
}
...
static uint8_t __scdep_1_follow(__scdep_in *_this) {
    ...
    if (_this->active >= 0) {
        ...
        /* line 42 */
        token_set(ghits, ((sc_afat){(void *)(intptr_t)(c + 1), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    }
    /* line 43 */
    return false;
}
...
int32_t main(void) {
    ...
    /* line 46 */
    token_form(sig, ((sc_afat){(void *)(intptr_t)(0), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0, (void*)0, (token_exec)0);
    /* line 47 */
    token_form(gauge, ((sc_afat){(void *)(intptr_t)(0), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0, (void*)0, (token_exec)0);
    /* line 48 */
    token_form(hits, ((sc_afat){(void *)(intptr_t)(0), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0, (void*)0, (token_exec)0);
    /* line 49 */
    token_form(ghits, ((sc_afat){(void *)(intptr_t)(0), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0, (void*)0, (token_exec)0);
    /* line 52 */
    token_set(sig, ((sc_afat){(void *)(intptr_t)(5), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    /* line 53 */
    token_set(sig, ((sc_afat){(void *)(intptr_t)(5), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    /* line 54 */
    token_set(sig, ((sc_afat){(void *)(intptr_t)(5), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    ...
    /* line 58 */
    token_set(sig, ((sc_afat){(void *)(intptr_t)(7), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    /* line 59 */
    int64_t h2 = ((int64_t)((token_get(hits)).p));
    /* line 60 */
    printf("直赋 set(7):      hits=%lld (期望 2)\n", h2);
    /* line 63 */
    token_set(gauge, ((sc_afat){(void *)(intptr_t)(10), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    /* line 64 */
    token_set(gauge, ((sc_afat){(void *)(intptr_t)(3), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    /* line 65 */
    int64_t g1 = ((int64_t)((token_get(ghits)).p));
    /* line 66 */
    printf("combine 取峰抑制:  ghits=%lld (期望 1)\n", g1);
    /* line 69 */
    token_set(gauge, ((sc_afat){(void *)(intptr_t)(0), (int32_t *)0, SC_OWN_RAW, (void (*)(void *))0}), 0);
    /* line 70 */
