...
int32_t main(void) {
    ...
    bool _sq1 = ring_is_empty(&r);
    bool _sq2 = ring_is_full(&r);
    ...
    bool _sq4 = ring_is_full(&r);
    bool _sq5 = ring_push(&r, &(x));
    ...
    /* line 53 */
    bool _sq6 = ring_is_empty(&r);
    uint64_t _sq7 = ring_len(&r);
    bool _sq8 = ring_pop(&r, &(v));
