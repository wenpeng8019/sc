...
do_test() {
    ...
    # 可运行特性系列：默认模式（编译+执行）
    local f
    for f in feature1 feature2 feature3 feature4 feature5 feature6 feature7 feature8 feature9 feature10 feature11 feature12 feature13 feature14 feature15 feature_forward; do
        echo "--- $f.sc（默认模式）---"
